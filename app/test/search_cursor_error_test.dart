...
void main() {
  testWidgets(
      'timeline-search caret error color is scheme.error; width 2; radius 1',
      (tester) async {
    ...
    expect(field.cursorErrorColor, scheme.error);
    expect(field.cursorColor, scheme.primary);
    expect(field.cursorWidth, 2);
    expect(field.cursorRadius, const Radius.circular(1));
  });
}
