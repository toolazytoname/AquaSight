...
void main() {
  testWidgets(
      'event-card-same-day-breaking-time nearest InkWell customBorder is radius 8; splash tokens stay; no onTap',
      (tester) async {
    _setDefaultSurface(tester);
    await _pumpDefault(tester);

    final timeFinder = find.byKey(_breakingTimeKey);
    expect(timeFinder, findsOneWidget);
    expect(tester.widget(timeFinder), isA<Text>());
