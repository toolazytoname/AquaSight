...
void main() {
  testWidgets(
      'timeline-clear-filters TextButton surfaceTintColor is transparent; elevation 0; shadow transparent; full-row min; radius 8',
      (tester) async {
    ...
    final button = tester.widget<TextButton>(find.byKey(_clearKey));
