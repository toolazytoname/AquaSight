...
void main() {
  testWidgets(
      'timeline and source-filter ScrollbarTheme trackColor is outlineVariant',
      (tester) async {
    ...
    expect(
      listTheme.trackColor?.resolve(const <WidgetState>{}),
      listScheme.outlineVariant,
    );
    expect(
    ...
    expect(
      sourceTheme.trackColor?.resolve(const <WidgetState>{}),
