...
void main() {
  testWidgets(
      'timeline-error-retry FilledButton surfaceTintColor is transparent; elevation 0; shadow transparent; min 48×48; radius 8',
      (tester) async {
    ...
    final button = tester.widget<FilledButton>(find.byKey(_errorRetryKey));
