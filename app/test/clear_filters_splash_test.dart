...
void main() {
  testWidgets(
      'timeline-clear-filters TextButton overlay uses theme primary splash 0.12 / 0.08',
      (tester) async {
    ...
    expect(tester.widget(clearFinder), isA<TextButton>());

    final button = tester.widget<TextButton>(clearFinder);
    final scheme = Theme.of(tester.element(clearFinder)).colorScheme;
