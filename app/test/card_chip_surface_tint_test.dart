...
void main() {
  testWidgets(
      'event-card-same-day-breaking-source-weibo Chip surfaceTintColor is transparent; elevation 0; shadowColor transparent; pressElevation 0; InkWell splash/hover/border stay',
      (tester) async {
