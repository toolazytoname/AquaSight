              ...
              child: NotificationListener<ScrollEndNotification>(
                ...
                child: ScrollbarTheme(
                  data: ScrollbarTheme.of(context).copyWith(
                    ...
                    trackColor: WidgetStatePropertyAll(scheme.outlineVariant),
...
class _FeedLatestSnackBar extends SnackBar {
  ...
  @override
  State<SnackBar> createState() => _FeedLatestSnackBarState();
}

class _FeedLatestSnackBarState extends State<_FeedLatestSnackBar> {
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return Theme(
...
/// colors via a local [Theme] so only this snack's [Material] drop shadow
/// and surface tint are transparent.
class _FeedErrorSnackBar extends SnackBar {
  const _FeedErrorSnackBar({
    super.key,
    required super.content,
    super.showCloseIcon,
    super.closeIconColor,
  ...
  @override
  State<SnackBar> createState() => _FeedErrorSnackBarState();
}

class _FeedErrorSnackBarState extends State<_FeedErrorSnackBar> {
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return Theme(
...
class _CopySnackBar extends SnackBar {
  ...
  @override
  State<SnackBar> createState() => _CopySnackBarState();
}

class _CopySnackBarState extends State<_CopySnackBar> {
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return Theme(
