...
void main() {
  testWidgets(
      'long-press event-card-same-day-breaking-time copy-snackbar uses 8px rounded floating shape',
      (tester) async {
  ...
  testWidgets(
      'pull-to-refresh feed-updated-snackbar uses 8px rounded floating shape',
      (tester) async {
    _setDefaultSurface(tester);
