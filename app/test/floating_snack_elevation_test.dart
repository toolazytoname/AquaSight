...
void main() {
  testWidgets(
      'long-press event-card-same-day-breaking-time copy-snackbar uses elevation 3',
      (tester) async {
  ...
  testWidgets(
      'pull-to-refresh feed-updated-snackbar uses elevation 3',
      (tester) async {
    _setDefaultSurface(tester);
      ...
      for (final id in ids)
        {
          ...
          'source': 'hn',
          'level': 'normal',
          'reason': 'floating-snack-elevation',
          'score': 1,
