...
class _EventCardState extends State<EventCard> {
  ...
  Widget _sourceChip(ColorScheme scheme, EventItem item, String name) {
    ...
    // Theme.copyWith makes Theme.of(...).chipTheme.elevation / pressElevation 0.
...
class _OpenErrorSnackBar extends SnackBar {
  ...
  @override
  State<SnackBar> createState() => _OpenErrorSnackBarState();
}

class _OpenErrorSnackBarState extends State<_OpenErrorSnackBar> {
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return Theme(
